...
from routers import auth_router, requisition_router, candidate_router, maingraph_router, interview_router, chat_router, user_router, calendar_router
...
# Include routers
# NOTE: user_router must come BEFORE requisition_router because requisition_router
# has a catch-all /{requisition_id} path at /api that would match /api/users first.
