...
Revision ID: 255f98bd04d2
Revises: 
Create Date: 2026-02-16 20:46:48.198447
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('lever_event_id', sa.String(length=255), nullable=False),
    ...
    op.create_index(op.f('ix_webhook_events_lever_event_id'), 'webhook_events', ['lever_event_id'], unique=True)
    ...
    sa.Column('cv_embedding_stored', sa.Boolean(), nullable=False),
    ...
    sa.Column('assessment_test_url', sa.String(length=1000), nullable=True),
    sa.Column('hackerrank_test_id', sa.String(length=255), nullable=True),
    ...
    sa.Column('stated_availability', sa.JSON(), nullable=True),
    ...
    sa.Column('education_degree', sa.String(length=255), nullable=True),
    ...
    op.create_index(op.f('ix_application_details_skill_name'), 'application_details', ['skill_name'], unique=False)
    ...
    sa.Column('behavioral_justification', sa.Text(), nullable=True),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_application_details_skill_name'), table_name='application_details')
    ...
    op.drop_index(op.f('ix_webhook_events_lever_event_id'), table_name='webhook_events')
