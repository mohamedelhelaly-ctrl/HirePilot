...
from models.tables.screening_result import ScreeningResult
from models.schemas.screeningResult_schemas import ScreeningResultCreate, ScreeningResultUpdate
