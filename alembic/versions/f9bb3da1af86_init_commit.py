...
Revision ID: f9bb3da1af86
Revises: 
Create Date: 2026-06-20 21:16:31.797506
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_google_oauth_credentials_google_account_email'), 'google_oauth_credentials', ['google_account_email'], unique=False)
    op.create_index(op.f('ix_google_oauth_credentials_id'), 'google_oauth_credentials', ['id'], unique=False)
    op.create_index(op.f('ix_google_oauth_credentials_user_id'), 'google_oauth_credentials', ['user_id'], unique=True)
    ...
    sa.Column('tech_questions', sa.JSON(), nullable=True),
    ...
    op.create_index(op.f('ix_chat_threads_external_id'), 'chat_threads', ['external_id'], unique=True)
    op.create_index(op.f('ix_chat_threads_id'), 'chat_threads', ['id'], unique=False)
    op.create_index(op.f('ix_chat_threads_requisition_id'), 'chat_threads', ['requisition_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_chat_threads_requisition_id'), table_name='chat_threads')
    op.drop_index(op.f('ix_chat_threads_id'), table_name='chat_threads')
    op.drop_index(op.f('ix_chat_threads_external_id'), table_name='chat_threads')
    ...
    op.drop_index(op.f('ix_google_oauth_credentials_user_id'), table_name='google_oauth_credentials')
    op.drop_index(op.f('ix_google_oauth_credentials_id'), table_name='google_oauth_credentials')
    op.drop_index(op.f('ix_google_oauth_credentials_google_account_email'), table_name='google_oauth_credentials')
